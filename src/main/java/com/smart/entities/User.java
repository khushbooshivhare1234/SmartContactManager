...
public class User {
	...
	private String name;
	@Column(unique = true)
	@Email(regexp = "^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$", message = "Email must be in the format example@example.com")
    ...
    @Size(min = 5,max=500, message = "About field must be 5 characters not exceed 500")
